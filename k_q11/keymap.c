...
[MAIN] = LAYOUT_91_ansi(
  ...
  _______ ,          _______      , GUI_A   , ALT_S   , CTL_D   , SFT_F   , KC_G    ,     KC_H    , SFT_J   , CTL_K   , ALT_L   , GUI_SLCN , _______ ,      _______      ,                               _______,
